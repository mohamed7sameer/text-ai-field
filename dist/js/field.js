...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    */
    ...
    // },
    moInputAi: function moInputAi(editor) {
      var _this2 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var finalData, moValue, response, dataJson;
            ...
            case 8:
              ...
              return fetch("http://csv.test/api/test", {
                ...
                body: JSON.stringify({
                  ...
                  // "email": emailField,
                  "field_name": _this2.field.attribute,
        ...
        setup: function setup(editor) {
          editor.ui.registry.addButton('customButton', {
            ...
            onAction: function onAction() {
              _this3.moInputAi(editor);
              // editor.insertContent('<strong>نص مخصص</strong>');
            }
          });
          editor.on('change', function () {
            // editor.save();
            _this3.value = _this3.field.value = editor.getContent();
          });
